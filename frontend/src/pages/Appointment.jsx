  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-xl">
      ...
      <div className="mt-6">
        ...
        <button className="mt-6 w-full bg-gradient-to-r from-blue-500 to-indigo-500 text-white font-semibold py-3 rounded-lg shadow-lg hover:opacity-90 transition-all duration-200">
          Book an Appointment
        </button>
      </div>
      {/* Related doctors */}
